...
ConnectionSettingsContract _buildConnectionSettingsHostContract(
  ...
  return state._presenter.present(
    ...
    supportsRemoteServerStart: state.widget.onStartRemoteServer != null,
    supportsRemoteServerStop: state.widget.onStopRemoteServer != null,
    supportsRemoteServerRestart: state.widget.onRestartRemoteServer != null,
    activeRemoteServerAction: state._activeRemoteServerAction,

...
class TranscriptTurnSegmenter {
  ...
  CodexActiveTurnState upsertItem(
    ...
    return turn.copyWith(
      ...
      itemSegmentIds: <String, String>{...turn.itemSegmentIds, item.itemId: segment.id},
  ...
  CodexTurnSegment? _segmentFromItem(CodexSessionActiveItem item) {
    ...
    return switch (item.blockKind) {
      ...
      CodexUiBlockKind.assistantMessage || CodexUiBlockKind.status || CodexUiBlockKind.error =>
      ...
      CodexUiBlockKind.workLogEntry || CodexUiBlockKind.commandExecution =>
        CodexTurnWorkSegment(
          id: segmentId,
          createdAt: item.createdAt,
          itemId: item.itemId,
